...
if (isset($_POST['submit'])) {
    ...
    $submit="INSERT INTO `reg` (`name`, `email`, `phone`, `password`, `cpassword`) VALUES ('$username', '$email', '$phone', '$pass', '$cpass')";

      $check=mysqli_query($conn,$submit);
if ($check) {
    ?>
...
?>
    ...
    <div class="container my-3"><span>Already Have an Account?</span><a href="login.php">Login Here</a></div>
